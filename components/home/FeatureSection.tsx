const FeatureSection = () => {
	return (
		<section className='max-w-7xl mx-auto px-6 mt-50 '>
			<div className='space-y-10 max-w-3xl mb-15'>
				<h2 className='text-5xl font-semibold max-w-3xl tracking-tight'>
			...
			<div className='grid grid-cols-3 gap-x-10 items-center '>
				<div className='py-10 px-5 h-84  space-y-10 border border-neutral-300 bg-neutral-50 dark:border-neutral-800 rounded-2xl dark:bg-linear-to-br from-neutral-700 via-neutral-950 to-neutral-900'>
					<svg
						fill='none'
						viewBox='0 0 302 154'
						width='100%'
					...
					>
						...
						></rect>
						<rect
							className='fill-neutral-400 dark:fill-[#353539] stroke-neutral-300 dark:stroke-neutral-700'
							height='7.5'
							opacity='0.8'
							rx='1.25'
							strokeWidth='0.5'
				...
				<div className='py-10 px-5 h-84 space-y-10 border border-neutral-300 bg-neutral-50 dark:border-neutral-800 rounded-2xl dark:bg-linear-to-tl from-neutral-800 via-neutral-950 to-neutral-900'>
					<svg
						fill='none'
						viewBox='0 0 302 154'
						width='100%'
					...
					>
						...
						<g clipPath='url(#clip0_1027_20429)'>
							<mask
								...
								y='11'
							>
								<path d='M154 11H134V31H154V11Z' fill='white'></path>
							</mask>
						...
						<defs>
							...
							>
								...
								<feGaussianBlur stdDeviation='5.25'></feGaussianBlur>
				...
				<div className='py-10 px-5 h-84 space-y-10 border border-neutral-300 bg-neutral-50 dark:border-neutral-800 rounded-2xl dark:bg-linear-to-bl from-neutral-800 via-neutral-950 to-neutral-900'>
					<svg
						fill='none'
						viewBox='0 0 302 154'
						width='100%'
					...
					>
						...
						<defs>
							...
							<clipPath id='clip0_1027_20473'>
								<rect fill='white' height='180' width='302'></rect>
							</clipPath>
						</defs>
					</svg>
					<div className='text-xl font-medium'>
